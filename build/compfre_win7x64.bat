...
cl ..\src\win\misc.c /I"%incpath%\api" /I"%incpath%\crt" /Zi /nologo /W3 /WX /O2 /Oi /D"_AMD64_" /D"_M_AMD64" /D"_WIN64" /D"_UNICODE" /D"UNICODE" /Zc:wchar_t /FAcs /Fa"%objpath%\misc.cod" /Fo"%objpath%\misc.obj" /Fd"%objpath%\vc90.pdb" /GS- /Gy /TC /c /errorReport:queue

cl ..\src\win\drv_comm.c /I"%incpath%\api" /I"%incpath%\crt" /Zi /nologo /W3 /WX /O2 /Oi /D"_AMD64_" /D"_M_AMD64" /D"_WIN64" /D"_UNICODE" /D"UNICODE" /Zc:wchar_t /FAcs /Fa"%objpath%\drv_comm.cod" /Fo"%objpath%\drv_comm.obj" /Fd"%objpath%\vc90.pdb" /GS- /Gy /TC /c /errorReport:queue

cl ..\src\win\public.c /I"%incpath%\api" /I"%incpath%\crt" /Zi /nologo /W3 /WX /O2 /Oi /D"_AMD64_" /D"_M_AMD64" /D"_WIN64" /D"_UNICODE" /D"UNICODE" /Zc:wchar_t /FAcs /Fa"%objpath%\public.cod" /Fo"%objpath%\public.obj" /Fd"%objpath%\vc90.pdb" /GS- /Gy /TC /c /errorReport:queue
